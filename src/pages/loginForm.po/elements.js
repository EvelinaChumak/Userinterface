...
module.exports = {
  lblLoginForm: new Label('//*[@class = "login-form__container"]', 'Login form'),
  txtPass: new TextBox('//*[@class = "login-form__field-row"]/input', 'Password input'),
  txtEmail: new TextBox('//*[@class = "align__cell"][1]/input', 'Email input'),
  txtDomain: new TextBox('//*[@class = "align__cell"][3]/input', 'Domain input'),
  btnDomainChoose: new Button('//*[@class = "dropdown__opener"]', 'Domain choose'),
